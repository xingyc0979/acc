# 1 "/home/sd/ACC_v09/ACC/src/xerror.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 9 "/home/sd/ACC_v09/ACC/src/xerror.c" 2
...
# 10 "/home/sd/ACC_v09/ACC/src/xerror.c" 2
...
# 13 "/home/sd/ACC_v09/ACC/src/xerror.c" 2

char * errmsg_fmt[] = {
                                 "The pointcut '%s' is not defined . ",
                                   "The 'callp' pointcut can not use wildcard character.",
                                        "The '%s' advice should not have return type .",
                                    "The '%s' is a keyword and it can not be the name of a user-defined pointcut.",
                             "The pointcut '%s' is already defined before.",
                            "Advice parameter '%s' is not used in the pointcut.",
                              "Advice parameter '%s' has been used multiple times in the pointcut. ",
                     "The identifier '%s' in the '%s' pointcut should be declared as a parameter of the advice function.",
                     "The 'intype' pointcut can only be used in an 'introduce' advice.",
                        "The 'introduce' advice can only have \'intype\' pointcut.",
                            "The parameter type of pointcut '%s' does not match the type specified in its definition.",
                      "\'proceed\' can only be used in an 'around' advice.",
                            "The format of ( * identifier) can only be used in an 'args' or 'result' pointcut.",
                     "The '%s' is not a valid advice type. Advice type should be \'before\', \'after\', \'around\', \'catch\', or \'introduce\' . ",
                   "Nested cflow() pointcut is not supported.",
                                "The 'infile' pointcut should take a string literal.",
                    "The keyword '%s' should be used , not '%s' . ",
                               "The '%s' pointcut should only take 1 parameter.",
                         "The 'catch' advice should be used with a single 'try()' pointcut or multiple 'try()' pointcuts connected by '||'.",
                        "The 'catch()' advice should have only 1 integral type parameter, which should not appear inside pointcut definition."
};


long currDefnLineNum = 0;
long currDefnBgnLn = 0;
...
# 199 "/home/sd/ACC_v09/ACC/src/xerror.c" 3 4
  ((void) sizeof ((
# 199 "/home/sd/ACC_v09/ACC/src/xerror.c"
  pos > 0
# 199 "/home/sd/ACC_v09/ACC/src/xerror.c" 3 4
...
# 199 "/home/sd/ACC_v09/ACC/src/xerror.c"
  "pos > 0"
# 199 "/home/sd/ACC_v09/ACC/src/xerror.c" 3 4
  , "/home/sd/ACC_v09/ACC/src/xerror.c", 199, __extension__ __PRETTY_FUNCTION__); }))
# 199 "/home/sd/ACC_v09/ACC/src/xerror.c"
                 ;
 ...
 s("/*"); s("UTAC__ACLINE__"); i(currDefnLineNum); s("*/");
   }
...
void outputDefnBgnLn() {
 ...
 true_nl();
 s("/*"); s("UTAC__ACLINE__"); i(currDefnBgnLn); s("*/");
 true_nl();
}
