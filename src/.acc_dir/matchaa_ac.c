...
__ac__type__insert@yyATTRIBUTES__ac__type__insert__end@
}yyATTRIBUTES; 
...
(((void )sizeof (((p1)?1:0))) , __extension__ ({ 

if (p1){
; }else{
__assert_fail("p1", "/home/sd/ACC_v09/ACC/src/.acc_dir/matchaa_ac.c", 137, __extension__ __PRETTY_FUNCTION__); }} )); 
...
if (p1){
; }else{
__assert_fail("p1", "/home/sd/ACC_v09/ACC/src/.acc_dir/matchaa_ac.c", 172, __extension__ __PRETTY_FUNCTION__); }} )); 
...
(((void )sizeof (((((*p)) < 'z' && ((*p)) > 'a')?1:0))) , __extension__ ({ 

if (((*p)) < 'z' && ((*p)) > 'a'){
; }else{
__assert_fail("(*p) < 'z' && (*p) > 'a'", "/home/sd/ACC_v09/ACC/src/.acc_dir/matchaa_ac.c", 253, __extension__ __PRETTY_FUNCTION__); }} )); } }}
