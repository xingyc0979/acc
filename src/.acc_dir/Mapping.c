...
case 1: yyTerm("am_error"); 

yyNoArgs(); 

break; 

case 2: yyTerm("am_float"); 

yyNoArgs(); 

break; 

case 3: yyTerm("am_double"); 

yyNoArgs(); 

break; 

case 4: yyTerm("am_ulong"); 

yyNoArgs(); 

break; 

case 5: yyTerm("am_slong"); 

yyNoArgs(); 

break; 

case 6: yyTerm("am_uword"); 

yyNoArgs(); 

break; 

case 7: yyTerm("am_sword"); 

yyNoArgs(); 

break; 

case 8: yyTerm("am_ubyte"); 

yyNoArgs(); 

break; 

case 9: yyTerm("am_sbyte"); 

yyNoArgs(); 

break; 

case 10: yyTerm("am_byteblock"); 

yyNoArgs(); 

break; 

case 11: yyTerm("am_nil"); 
