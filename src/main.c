...
void process_args(int argc,char **argv,char *** aFiles,char *** nFiles, int * aNum, int * nNum);
void define_target_file_name (char *str);
...
void process_args(argc, argv, aFiles, nFiles, aNum, nNum)
